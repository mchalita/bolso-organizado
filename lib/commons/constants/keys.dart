...
class Keys {
  ...
  // Onboarding page
  static const onboardingGetStartedButton =         Key('onboarding_get_started_button');
  ...
  static const signUpConfirmPasswordField =     Key('sign_up_confirm_password_field');
  static const signUpButton =                   Key('sign_up_button');
  static const signUpShowHidePasswordButton =   Key('sign_up_show_hide_password_button');
  ...
  static const signInShowHidePasswordButton = Key('sign_in_show_hide_password_button');
  static const signInDontHaveAccountButton =  Key('sign_in_dont_have_account_button');

  // // App bottom bar items
  static const homePageBottomAppBarItem =    Key('home_page_bottom_app_bar_item');
  static const statsPageBottomAppBarItem =   Key('stats_page_bottom_app_bar_item');
  static const walletPageBottomAppBarItem =  Key('wallet_page_bottom_app_bar_item');
